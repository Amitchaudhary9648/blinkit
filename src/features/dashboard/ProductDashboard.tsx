          ...
          <CollapsibleScrollView
            ...
            style={styles.panelContainer}>
              ...
              <View style={{backgroundColor: '#F8F8F8', padding: 20}}>
                <CustomText fontSize={RFValue(32)} fontFamily={Fonts.Bold} style={{opacity: 0.5,}}>
                  India's last minute app ❤️
                </CustomText>
                <CustomText 
                  fontFamily={Fonts.Bold} 
                  style={{opacity: 0.5, marginTop: 10, paddingBottom: 100}}>
                  Blinkit
                </CustomText>
              </View>
          </CollapsibleScrollView>
...
export default withLiveStatus(withCollapsibleContext(ProductDashboard))